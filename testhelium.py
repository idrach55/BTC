...
class MyTest(unittest.TestCase):
    ...
    def test_onPartialFill(self):
        ...
        assert strat.openOrders == {"A1": Order("A1", "sell", 100.10, 0.5),
                                    "B1": Order("B1", "buy", 100.00, 0.5)}
    ...
    def test_onCompleteFill(self):
        ...
        assert strat.openOrders == {"A1": Order("A1", "sell", 100.10, 1.0)}
    ...
    def test_lockdownOnExcessiveVolality(self):
        ...
        assert strat.lockdownReason == "excessive volatility"
    ...
    def test_lockdownOnMaxDistance(self):
        ...
        book.done("Z4") 
        assert strat.enabled == False
        assert strat.lockdownReason == "max distance exceeded"